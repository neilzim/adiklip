...
data_dir = os.path.expanduser('/Volumes/MacDataHDD/GJ504/2014mar13/sat')
...
template_img_fname = '%s/gj504_nb8-mar13_klip_rad212-252_mode015-015_res_coadd.fits'  % klipsub_result_dir
synthpsf_fname = '%s/reduc/gj504_nb8-mar13_psf_model.fits' % data_dir
N_proc = 4
synthpsf_rolloff = 20.
...
klipsub_archv_fname = "%s/gj504_nb8-mar13_src_K15_refgap10_klipsub_archv.pkl" % klipsub_result_dir
psol_nb8mar13 = klipmod(ampguess=0.7, posguess_rho=232.5, posguess_theta=-35., klipsub_archv_fname=klipsub_archv_fname,
