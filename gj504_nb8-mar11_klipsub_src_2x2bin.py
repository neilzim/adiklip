...
#dataset_label = 'gj504_nb6_2x2bin'
dataset_label = 'gj504_nb8-mar11_2x2bin'
#result_label = 'gj504_nb8-mar11_src_K10'
#result_label = 'gj504_nb8-mar11_src_K01'
#result_label = 'gj504_nb8-mar11_src_K00_refgap10'
result_label = 'gj504_nb8-mar11_src_K20_refgap05'
data_dir = os.path.expanduser('/disk1/zimmerman/GJ504/mar11_nb8/reduc')
result_dir = os.path.expanduser('/disk1/zimmerman/GJ504/mar11_nb8/klipsub_results')
#
