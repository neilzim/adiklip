...
data_dir_mar11 = '/Volumes/MacDataHDD/GJ504/2014mar11/sat'
data_dir_mar13 = '/Volumes/MacDataHDD/GJ504/2014mar13/sat'
...
test_res_img_fname_mar11 = '%s/gj504_nb8-mar11_klip_rad212-252_mode030-030_res_coadd.fits'  % klipsub_result_dir_mar11
test_res_img_fname_mar13 = '%s/gj504_nb8-mar13_klip_rad212-252_mode015-015_res_coadd.fits'  % klipsub_result_dir_mar13
synthpsf_fname_mar11 = '%s/reduc/gj504_nb8-mar11_psf_model.fits' % data_dir_mar11
synthpsf_fname_mar13 = '%s/reduc/gj504_nb8-mar13_psf_model.fits' % data_dir_mar13
mode_cut_mar11 = 30
mode_cut_mar13 = 15
N_proc = 4
synthpsf_rolloff = 20.
...
test_res_img_hdulist.close()
xy_src = (test_res_img_mar11.shape[0]/2 - 0.5 + 134.9, test_res_img_mar11.shape[0]/2 - 0.5 + 189.4)
src_rad_map = np.sqrt(get_radius_sqrd(test_res_img_mar11.shape, c = xy_src))
test_ind = np.where( src_rad_map > 8. )
...
result_label = 'gj504_nb8-comb_mar11modecut%02d_mar13modecut%02d_weightsON' % (mode_cut_mar11, mode_cut_mar13)
...
klipsub_archv_fname_mar11 = "%s/gj504_nb8-mar11_src_K30_refgap10_klipsub_archv.pkl" % klipsub_result_dir_mar11
#klipsub_archv_fname_mar13 = "%s/gj504_nb8-mar13_src_K20_refgap10_klipsub_archv.pkl" % klipsub_result_dir_mar13
klipsub_archv_fname_mar13 = "%s/gj504_nb8-mar13_src_K15_refgap10_klipsub_archv.pkl" % klipsub_result_dir_mar13
#psol_nb8 = twoobs_klipmod(ampguess=0.33, posguess_rho=117., posguess_theta=-35.,
psol_nb8 = twoobs_klipmod(ampguess=0.6, posguess_rho=232.5, posguess_theta=-35.5,
