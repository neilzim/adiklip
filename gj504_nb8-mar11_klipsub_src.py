...
data_dir = os.path.expanduser('/Volumes/MacDataHDD/GJ504/2014mar11/sat/reduc')
result_dir = os.path.expanduser('/Volumes/MacDataHDD/GJ504/2014mar11/sat/klipsub_results')
#
...
mode_cut = [30]
min_refgap_fac = [1.0]
result_label = 'gj504_nb8-mar11_src_K%02d_refgap%02d' % (mode_cut[0], round(10*min_refgap_fac[0]))
